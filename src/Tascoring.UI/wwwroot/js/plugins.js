...
//    console.log("test");
//    var $div = $(this);
//    if ($div.css('margin-left') === "0px") {
//        $div.css("margin-left", "200px !important");
//        $divBox.css("margin-left", "0px");
//    } else {
//        $div.css("margin-left", "0px");
//        $divBox.css("margin-left", "-200px");
//    }
//});
/*global jQuery, var, $ */
...
(function ($) {
	...
	const $divIcon = $('div.icon-cog');
	const $divBoxLayout = $('div.box-layout');
	// Layout cog
	$divIcon.on('click', function () {
		if ($(this).css("margin-left") === "200px") {
			$divBoxLayout.animate({
				"margin-left": '-=200'
			});
			$divIcon.animate({
				"margin-left": '-=200'
